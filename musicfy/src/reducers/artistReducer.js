...
export default (state = INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    case NEW_ARTIST:
      ...
      if (
        !searchHistory.find((artist) => artist.name === action.payload.name)
      ) {
    ...
    case SELECT_MAIN_PLAYER_MENU_ITEM:
        console.log('salvou mesmo')
      return { ...state, mainPlayerMenu: action.payload}
    default:
      return state;
  }
};
